...
[Models]
  ...
  [overstress]
    ...
    from_var = 'state/internal/M state/internal/X1'
    coefficients = '1 -1'
  []
  [vonmises]
    type = SR2Invariant
  ...
  [implicit_rate]
    type = ComposedModel
    models = 'mandel_stress overstress vonmises yield normality flow_rate eprate Eprate X1rate Erate Eerate elasticity integrate_stress integrate_X1'
  []
  [model]
    type = ImplicitUpdate
