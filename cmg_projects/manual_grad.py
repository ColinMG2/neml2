...
model = neml2.load_model("test_model.i", "system")
...
strain_tensor[:, 1] = -0.5 * strain_11_exp
strain_tensor[:, 2] = -0.5 * strain_11_exp

stress_tensor[:, 0] = stress_11_exp
stress_tensor[:, 1] = -0.5 * stress_11_exp
stress_tensor[:, 2] = -0.5 * stress_11_exp
